...
export const metadata = {
  title: 'Enfermedades Laborales - Estudio Rampazzo',
  description: 'Protección legal en casos de enfermedades profesionales',
};
...
export default function EnfermedadesLaboralesPage() {
  return (
    <PageLayout
      ...
      defaultService="enfermedades-laborales">
      <div className="grid md:grid-cols-6 md:gap-x-[1.25vw] text-[#1B1743]">
        <div className="md:col-span-4">
          ...
          <p className="pb-[60px] md:pb-[5.55vh] text-sm md:text-[1.48vh] leading-5 md:leading-[2.22vh] font-medium">
            En Estudio Rampazzo nos especializamos en enfermedades laborales, brindando asesoramiento legal integral y personalizado para proteger sus derechos y obtener los mejores resultados en su caso.
          </p>
          ...
          <div className="h-fit px-4 py-4 md:px-[1.25vw] md:py-[2.22vh] bg-[#F8F6F7] border-[0.09vh] border-[#F0F0F5] rounded-md shadow-md mb-[60px] md:mb-[5.55vh]">
            <p className="font-medium text-[#962C52]">
              Contamos con amplia experiencia en enfermedades laborales y un equipo de profesionales especializados que le brindarán el mejor asesoramiento legal.
            </p>
          </div>
