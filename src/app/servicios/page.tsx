...
const services = [
    {
        ...
        title: 'Despidos',
        description:
            'Asesoramiento y representación legal para trabajadores despedidos injustamente.',
        content: [
    ...
    },
    {
        ...
        description:
            'Reclamos ante la ART por accidentes de trabajo y enfermedades profesionales.',
        content: [
    ...
    },
    {
        ...
        title: 'Divorcios',
        description:
            'Asesoramiento legal en procesos de divorcio y derecho de familia.',
        content: [
            'Divorcio express',
            'División de bienes',
            'Custodia de hijos',
    ...
    },
    {
        ...
        description:
            'Asesoramiento legal para trabajadores en situación irregular.',
        content: [
    ...
    {
        id: 'incapacidad',
        icon: <FaCalculator className="w-8 h-8 text-[#962C52]" />,
        title: 'Calculadora de Incapacidad',
        description:
            'Calcula tu prestación por Incapacidad Laboral Permanente según la Ley 26.773.',
        content: [
            'Cálculo automático de prestaciones',
            'Fórmula oficial actualizada',
            ...
            <div className="grid md:grid-cols-6 md:gap-x-[1.25vw] text-[#1B1743]">
                <div className="md:col-span-6">
                    <div className="mb-[60px] md:mb-[5.55vh]">
                        <h1
                            className={`pb-4 md:pb-[2.59vh] text-[24px] md:text-[3.33vh] leading-[26px] md:leading-[3.51vh] font-bold ${evolventa.className}`}
                        >
                            Servicios Legales Integrales
                        </h1>
                        <p className="text-sm md:text-[1.48vh] leading-5 md:leading-[2.22vh] font-medium">
                            En Estudio Rampazzo ofrecemos asesoramiento legal
                            especializado en todas las áreas del derecho.
                            Nuestro equipo de abogados con amplia experiencia
                            está comprometido en proteger tus derechos y obtener
                            los mejores resultados para tu caso.
                        </p>
                    </div>
                    ...
                    <div className="h-fit px-4 py-4 md:px-[1.25vw] md:py-[2.22vh] bg-[#F8F6F7] border-[0.09vh] border-[#F0F0F5] rounded-md shadow-md mb-[60px] md:mb-[5.55vh]">
                        <p className="font-medium text-[#962C52]">
                            Más de 15 años de experiencia en el rubro legal nos
                            permiten ofrecerte el mejor asesoramiento para que
                            accedas a tus derechos de la manera más beneficiosa.
                        </p>
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                ...
                                <p className="text-sm md:text-[1.48vh] leading-5 md:leading-[2.22vh] font-medium">
                                    ...
                                    legal nos permiten ofrecerte el mejor
                                    asesoramiento.
                                </p>
                            </div>
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                ...
                                <p className="text-sm md:text-[1.48vh] leading-5 md:leading-[2.22vh] font-medium">
                                    Cada caso es único y merece atención
                                    personalizada. Nos comprometemos a brindarte
                                    el mejor servicio.
                                </p>
                            </div>
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                ...
                                <p className="text-sm md:text-[1.48vh] leading-5 md:leading-[2.22vh] font-medium">
                                    Nuestro objetivo es obtener los mejores
                                    resultados para nuestros clientes,
                                    protegiendo siempre sus derechos.
                                </p>
                            </div>
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                ...
                                <p className="text-sm md:text-[1.48vh] leading-5 md:leading-[2.22vh] font-medium">
                                    ...
                                    legal con claridad, eficiencia y resultados
                                    concretos.
                                </p>
                            </div>
                        </div>
