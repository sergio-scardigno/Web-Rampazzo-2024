...
const Clients = () => {
  return (
    <section className="mt-6 bg-gradient-to-r from-[#EBECF1] to-[#FCFCFD]">
      <div className="px-3 md:px-[12.5vw] py-[60px] md:py-[11.11vh] grid grid-cols-3 md:grid-cols-6 md:gap-x-[1.25vw] ">
        <h1
          className={`md:col-start-3 text-left  col-span-3 md:col-span-4 md:text-[3.33vh] text-[24px] leading-[26px] md:leading-[3.51vh] font-bold text-[#1B1743] pb-6 md:pb-[7.4vh]`}
        >
          EL ABOGADO DE CRONICA TV
        </h1>
